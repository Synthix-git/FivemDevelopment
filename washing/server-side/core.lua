...
local COMBO_BONUS_MIN = 1000
local COMBO_BONUS_MAX = 2500

-- Valores por ponto
local MIN_PER_WASH = 1500

-- Teto variável por nº de polícias por ponto:
-- 0→30k; 3→60k; 5→80k; 10+→100k
local function MaxPerWashByCops(n)
	if n >= 10 then return 100000 end
	if n >= 5  then return 80000 end
	if n >= 3  then return 60000 end
	return 30000
end
